...
as one layout island and applies the same source-to-output column shift to every physical
comment line. Its indentation therefore does not depend on how the parser divides the
comment into tokens.
